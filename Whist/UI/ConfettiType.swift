...
struct RoundedCross_Previews: PreviewProvider {
    static var previews: some View {
        Group {
            RoundedCross()
                .previewDisplayName( "RoundedCross" )
            SlimRectangle()
                .previewDisplayName( "SlimRectangle" )
            Triangle()
...
#if DEBUG
struct ConfettiCannonDemo: View {
...
struct ConfettiCannonDemo_Previews: PreviewProvider {
    static var previews: some View {
        ConfettiCannonDemo()
            .previewDisplayName("Confetti Cannon Demo")
    }
}
#endif
